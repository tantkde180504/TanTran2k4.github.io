...
window.QUIZ_SUBJECTS = {
  prm: {
    ...
    storageWrong: "uq-prm-wrong-v2",
    storageProgress: "uq-prm-progress-v2",
    cloudSubject: "prm",
    multiSelect: true,
  ...
  mln: {
    ...
    storageWrong: "uq-mln-wrong-v2",
    storageProgress: "uq-mln-progress-v2",
    cloudSubject: "mln",
    multiSelect: true,
  ...
  jit: {
    ...
    storageWrong: "uq-jit-wrong-v2",
    storageProgress: "uq-jit-progress-v2",
    cloudSubject: "jit",
    multiSelect: false,
    showTranslationAlways: true,
    tasks: [
  ...
  fe: {
    ...
    storageWrong: "uq-fe-wrong-v2",
    storageProgress: "uq-fe-progress-v2",
    cloudSubject: "fe",
    multiSelect: false,
    showTranslationAlways: true,
    tasks: [
